...
class ShaneProtossBot(sc2.BotAI):
    def __init__(self):
        self.ITERATIONS_PER_MINUTE = 165
        self.MAX_WORKERS = 70
        self.MAX_GATEWAYS = 10
    ...
    async def on_step(self, iteration):
        ...
        await self.expand().distribute_workers()
    ...
    async def build_assimilator(self):
        for nexus in self.units(NEXUS).ready:
            vespenes = self.state.vespene_geyser.closer_than(20.0, nexus)
...
run_game(maps.get("AbyssalReefLE"), [
    Bot(Race.Protoss, ShaneProtossBot()),
